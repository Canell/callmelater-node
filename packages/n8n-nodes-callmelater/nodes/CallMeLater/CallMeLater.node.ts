			...
			},
			{
				...
				options: [
					...
					},
					{
						...
						type: 'string',
						default: '',
						description: 'URL to receive webhooks when action is executed or fails. Use CallMeLater Trigger node to receive these events.',
					},
				],
			},
			...
			},
			{
				...
				options: [
					...
					},
					{
						...
						type: 'string',
						default: '',
						description: 'URL to receive webhooks when someone responds, action executes, or expires. Use CallMeLater Trigger node to receive these events.',
					},
				],
			},
