                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="legal-content">
                            ...
                            <h2>10. Cookies</h2>
                            <p>CallMeLater uses only strictly necessary cookies required for authentication and security. See the <router-link to="/cookies">Cookie Notice</router-link> for details.</p>
